...
impl Renderable<Calculator> for Calculator {
    fn view(&self) -> Html<Self> {
        let display = || {
            html! {
                <>
                <input class="mdl-textfield__input", id="display", placeholder="0.", disabled=true, value=&self.display(),>
                </input>
                </>
            }
        };
        ...
        let digit_button = |digit: char| {
            html! {
                <>
                <input class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect butt", type="button", value=digit.to_string(), onclick=|_| Msg::Digit(digit),>
                </input>
                </>
            }
        };
        ...
        let op_button = |op: Operator| {
            ...
            html! {
                <>
                <input class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect butt", type="button", value=sop.to_string(), onclick=|_| Msg::Op(op),>
                </input>
                </>
            }
        };
        ...
        let dot_button = || {
            html!{
                <>
                <input class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect butt", type="button", value=".", onclick=|_| Msg::Digit('.'),>
                </input>
                </>
            }
        };
        ...
        let equal_button = || {
            html! {
                <>
                <input class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect butt", type="button", value="=", onclick=|_| Msg::Equal,>
                </input>
                </>
            }
        };
        ...
        let clear_reset_buttons = || {
            html!{
                ...
                <div class="row mx-auto",>
                    <input class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored buttbig", type="button", value="Clear", onclick=|_| Msg::Clear, >
                    </input>
                    <input class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent buttbig", type="button", value="Reset", onclick=|_| Msg::Reset,>
                    </input>
                </div>
                </>
            }
