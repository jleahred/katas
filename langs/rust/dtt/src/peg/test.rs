...
// #[test]
// fn test_tranf2_singleline_on_peg() {
//     let peg = r#"
//     main    =   "aaa"        ->Hi
//             /   "bb" c*
//             / ((d f)+        ->nested
...
//     println!("{:?}", parse(peg, &peg::rules::parse_peg()));
//     assert!(parse(peg, &peg::rules::parse_peg()).is_ok());
// }

// #[test]
// fn test_named_on_peg() {
//     let peg = r#"
//     main    =   as:"aaa"        ->Hi
//             /   bb:"bb" cs:c*
//             / complex:((d f)+   ->nested
...
//     println!("____ {:#?}", parse("aa", &rules).unwrap());
//     println!(
//         "____ {:#?}",
//         parse("aa", &rules).unwrap().compact().flatten()
//     );
