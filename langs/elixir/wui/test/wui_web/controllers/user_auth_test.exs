defmodule WuiWeb.UserAuthTest do
  use WuiWeb.ConnCase

  alias Wui.Accounts
  alias WuiWeb.UserAuth
  import Wui.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, WuiWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "log_in_user/3" do
    ...
    test "redirects to the configured path", %{conn: conn, user: user} do
      conn =
        conn |> put_session(:user_return_to, "/hello") |> UserAuth.log_in_user(user)
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      WuiWeb.Endpoint.subscribe(live_socket_id)
