defmodule Wui5CommonWeb.Macros.AutoRoutes do
  @moduledoc """
  ...
  defmacro auto_live_routes(directory_path, opts \\ []) do
    ...
    quote bind_quoted: [
      ...
      modules =
        Wui5CommonWeb.Macros.AutoRoutes.find_modules_with_meta(
          directory_path,
          module_suffix
        )
      ...
      for {module, meta} <- modules do
        ...
        live(
          ...
          module,
          :index,
          as: Wui5CommonWeb.Macros.AutoRoutes.route_name_from_module(module)
        )
      end
    end
  end
