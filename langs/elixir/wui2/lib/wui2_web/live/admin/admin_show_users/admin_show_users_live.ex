# defmodule Wui2Web.AdminShowUsersLive do
...
#     from =
#       "#{Routes.live_path(socket, Wui2Web.AdminShowUsersLive)}?#{params |> Map.from_struct() |> URI.encode_query()}"
...
#       socket
#       |> push_patch(
#         to: Routes.live_path(socket, Wui2Web.AdminShowUsersLive) <> url_params
#       )
#       #
#     }
#   end
